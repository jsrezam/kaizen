...
namespace Kaizen.Migrations
{
    ...
    [Migration("20210526213154_AddValidFieldsToCampaignDetail")]
    partial class AddValidFieldsToCampaignDetail
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kaizen.Core.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Kaizen.Core.Models.Campaign", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Kaizen.Core.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Kaizen.Core.Models.Campaign", b =>
                {
                    b.HasOne("Kaizen.Core.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Kaizen.Core.Models.CampaignDetail", b =>
                {
                    b.HasOne("Kaizen.Core.Models.Campaign", "Campaign")
            ...
            modelBuilder.Entity("Kaizen.Core.Models.OrderDetail", b =>
                {
                    b.HasOne("Kaizen.Core.Models.Order", "order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Kaizen.Core.Models.Product", "Product")
                        .WithMany("OrderDetails")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Kaizen.Core.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
